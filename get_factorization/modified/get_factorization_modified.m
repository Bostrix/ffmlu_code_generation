function F = get_factorization_modified(center,area,normals,qcorr,contrast,weight,opts)
%
...
%
    ...
    tic, F = srskelf_asym_new_modified(Afun_use,x,occ,rank_or_tol,pxyfun_use,opts_use); tfac = toc;
