            ...
            array<real_T, 2U> &Q, array<real_T, 2U> &R, array<int32_T, 2U> &E)
{
  ...
  st.site = &em_emlrtRSI;
  b_A.set_size(&pn_emlrtRTEI, &st, A.size(0), A.size(1));
  ...
  R.set_size(&nn_emlrtRTEI, &st, minsz, b_A.size(1));
  ...
  c_A.set_size(&qn_emlrtRTEI, &b_st, b_A.size(0), b_A.size(1));
  ...
  internal::lapack::xorgqr(c_st, b_A.size(0), minsz, minsz, c_A, b_A.size(0),
                           tau);
  Q.set_size(&on_emlrtRTEI, &st, b_A.size(0), minsz);
