                 ...
                 coder::array<real_T, 2U> &T_lvp, real_T &T_lrt)
{
  ...
  while (!(exitg1 || (nlvl >= lvlmax))) {
    ...
    if ((static_cast<int32_T>(static_cast<real_T>(nlvl) + 1.0) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(
          ...
          T_lvp.size(1), &yd_emlrtBCI, (emlrtConstCTX)&sp);
    }
    ...
    for (int32_T prnt{0}; prnt < b_i; prnt++) {
      ...
      if (loop_ub > occ) {
        ...
        for (k = 0; k < i1; k++) {
          uint32_T u;
          if (k + 1 > i1) {
            emlrtDynamicBoundsCheckR2012b(k + 1, 1, i1, &xd_emlrtBCI,
                                          (emlrtConstCTX)&sp);
          }
          //  % while mbox < nbox
          //  %            e = cell(mbox,1);
    ...
    if (static_cast<int32_T>(nbox) <= nbox_) {
      ...
      while (mlvl < nlvl) {
        ...
        if (b_prnt != static_cast<int32_T>(b_prnt)) {
          emlrtIntegerCheckR2012b(b_prnt, &ob_emlrtDCI, (emlrtConstCTX)&sp);
        }
      ...
      if ((static_cast<int32_T>(static_cast<real_T>(nlvl) + 1.0) < 1) ||
        ...
        emlrtDynamicBoundsCheckR2012b(
            static_cast<int32_T>(static_cast<real_T>(nlvl) + 1.0), 1,
            T_lvp.size(1), &qe_emlrtBCI, (emlrtConstCTX)&sp);
      }
  ...
  if (static_cast<real_T>(nlvl) != static_cast<int32_T>(nlvl)) {
    emlrtIntegerCheckR2012b(static_cast<real_T>(nlvl), &pb_emlrtDCI,
                            (emlrtConstCTX)&sp);
  }
  ...
  for (int32_T prnt{0}; prnt < b_i; prnt++) {
    ...
    if ((static_cast<int32_T>((static_cast<real_T>(prnt) + 1.0) + 1.0) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(
          ...
          static_cast<int32_T>(static_cast<real_T>(nlvl) + 1.0), &md_emlrtBCI,
          (emlrtConstCTX)&sp);
    }
    d = T_lvp[prnt + 1];
    if (T_lvp[prnt] + 1.0 > d) {
      ...
      if ((static_cast<int32_T>(d) < 1) ||
        ...
        emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(d), 1,
                                      static_cast<int32_T>(nbox), &kd_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
    ...
    if ((static_cast<int32_T>(static_cast<uint32_T>(prnt) + 1U) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(
          ...
          llvl.size(0), &te_emlrtBCI, (emlrtConstCTX)&sp);
    }
    llvl[prnt] = l;
    l *= 0.5;
    if (*emlrtBreakCheckR2012bFlagVar != 0) {
  ...
  for (int32_T prnt{0}; prnt < b_i; prnt++) {
    ...
    if ((static_cast<int32_T>(static_cast<uint32_T>(prnt) + 2U) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(
          ...
          llvl.size(0), &re_emlrtBCI, (emlrtConstCTX)&sp);
    }
    l = llvl[prnt + 1];
    if ((static_cast<int32_T>(static_cast<uint32_T>(prnt) + 2U) < 1) ||
        (static_cast<int32_T>(static_cast<uint32_T>(prnt) + 2U) >
      ...
      emlrtDynamicBoundsCheckR2012b(
          static_cast<int32_T>(static_cast<uint32_T>(prnt) + 2U), 1,
          static_cast<int32_T>(static_cast<real_T>(nlvl) + 1.0), &se_emlrtBCI,
          (emlrtConstCTX)&sp);
    }
    d = T_lvp[prnt + 1] + 1.0;
    if ((static_cast<int32_T>((static_cast<real_T>(prnt) + 2.0) + 1.0) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(
          ...
          static_cast<int32_T>(static_cast<real_T>(nlvl) + 1.0), &ud_emlrtBCI,
          (emlrtConstCTX)&sp);
    }
    d1 = T_lvp[prnt + 1] + 1.0;
    b_prnt = T_lvp[prnt + 2];
    ...
    for (int32_T i{0}; i < i2; i++) {
      ...
      if ((static_cast<int32_T>(mlvl) < 1) ||
        ...
        emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(mlvl), 1,
                                      static_cast<int32_T>(nbox), &td_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      ...
      for (k = 0; k < nbox_; k++) {
        if ((r3[k] < 0) || (r3[k] > idx)) {
          emlrtDynamicBoundsCheckR2012b(r3[k], 0, idx, &ue_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
      ...
      for (idx = 0; idx < loop_ub; idx++) {
        k = T_nodes[static_cast<int32_T>(
                ...
                .chld.size(1);
        if (idx + 1 > loop_ub) {
          emlrtDynamicBoundsCheckR2012b(idx + 1, 1, loop_ub, &xe_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        partialTrueCount = static_cast<int32_T>(nbor_indices[idx]);
        if ((partialTrueCount < 1) || (partialTrueCount > k)) {
          emlrtDynamicBoundsCheckR2012b(partialTrueCount, 1, k, &rd_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        ...
        for (trueCount = 0; trueCount < loop_ub; trueCount++) {
          if (trueCount + 1 > nbor_indices.size(1)) {
            emlrtDynamicBoundsCheckR2012b(trueCount + 1, 1,
                                          nbor_indices.size(1), &qd_emlrtBCI,
                                          (emlrtConstCTX)&sp);
          }
