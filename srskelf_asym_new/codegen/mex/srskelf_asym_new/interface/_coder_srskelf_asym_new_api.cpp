                                        ...
                                        const struct1_T &u)
{
  ...
  emlrtAssign(&e_y, emlrtCreateStructArray(
                        1, ((coder::array<empty, 1U> *)&u.factors)->size(), 10,
                        (const char_T **)&sv1[0]));
                            ...
                            const mxArray *const prhs[6], const mxArray **plhs)
{
  ...
  emlrt_marshallIn(st, emlrtAliasP(prhs[5]), "opts", SD->f2.opts);
