                   ...
                   int32_T B_size, real_T Y_data[])
{
  ...
  if ((A_size[0] == 0) || (A_size[1] == 0) || (B_size == 0)) {
    ...
    memcpy(&c_A_data[0], &A_data[0], (uint32_T)loop_ub * sizeof(real_T));
    ...
    b_A_size[1] = A_size[1];
    loop_ub = A_size[0] * A_size[1];
    memcpy(&b_A_data[0], &A_data[0], (uint32_T)loop_ub * sizeof(real_T));
    c_st.site = &vd_emlrtRSI;
    xgeqp3(&c_st, b_A_data, b_A_size, tau_data, jpvt_data, jpvt_size);
    c_st.site = &wd_emlrtRSI;
    rankA = rankFromQR(&c_st, b_A_data, b_A_size);
              ...
              const int32_T B_size[2], real_T Y_data[], int32_T Y_size[2])
{
  ...
  if ((A_size[0] == 0) || (A_size[1] == 0) ||
    ...
    memcpy(&Y_data[0], &B_data[0], (uint32_T)loop_ub * sizeof(real_T));
    d_st.site = &id_emlrtRSI;
    e_st.site = &kd_emlrtRSI;
    i = muIntScalarMin_sint32(A_size[0], A_size[1]);
