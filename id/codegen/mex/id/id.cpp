                             ...
                             const int32_T in5_size[2])
{
  ...
  in1_size[0] = loop_ub;
  if (in5_size[1] == 1) {
    b_loop_ub = 4 - static_cast<int32_T>(in4);
  } else {
    b_loop_ub = in5_size[1];
  }
  in1_size[1] = b_loop_ub;
  stride_0_0 = (in3 != 1);
  stride_0_1 = (4 - static_cast<int32_T>(in4) != 1);
    ...
    for (int32_T i1{0}; i1 < loop_ub; i1++) {
      in1_data[i1 + in1_size[0] * i] =
          in2_data[i1 * stride_0_0 +
                   in2_size[0] * ((static_cast<int32_T>(in4) + aux_0_1) + 1)] +
                                  ...
                                  const int32_T &in3_size)
{
  ...
  if (in1_size - 1 >= 0) {
    std::copy(&b_in1_data[0], &b_in1_data[in1_size], &in1_data[0]);
  }
  return in1_size;
}
    ...
    const boolean_T in8_data[], const int32_T in8_size[2])
{
  ...
  for (int32_T i{0}; i <= vectorUB; i += 2) {
    ...
    __m128d r1;
    r = _mm_loadu_pd(
        &in4_data[i + in4_size[0] * (static_cast<int32_T>(in5) - 1)]);
  ...
  for (int32_T i{0}; i < loop_ub_tmp; i++) {
    b_in7_data[i] = static_cast<real_T>(in7_data[i * scalarLB]) -
                    static_cast<real_T>(in8_data[i * vectorUB]);
  }
  st.site = const_cast<emlrtRSInfo *>(&in1);
  coder::qrupdate(st, in2_data, in2_size, in3_data, in3_size, b_in4_data,
                  static_cast<int32_T>(in5), b_in7_data, loop_ub_tmp);
}
                               ...
                               const int32_T in2_size[2], real_T in3)
{
  ...
  if (in1_size[1] == 1) {
    b_loop_ub = 5 - static_cast<int32_T>(in3);
  } else {
    b_loop_ub = in1_size[1];
  }
  stride_0_0 = (static_cast<int32_T>(in3) != 1);
  stride_0_1 = (5 - static_cast<int32_T>(in3) != 1);
  ...
  for (int32_T i{0}; i < b_loop_ub; i++) {
    for (int32_T i1{0}; i1 < loop_ub; i1++) {
      b_in2_data[i1 + loop_ub * i] =
          in2_data[i1 * stride_0_0 +
                   in2_size[0] * (static_cast<int32_T>(in3) + aux_0_1)] -
                   ...
                   const boolean_T in10_data[], const int32_T in10_size[2])
{
  ...
  stride_1_0 = (in7 != 1);
  for (int32_T i{0}; i < loop_ub; i++) {
    b_in4_data[i] = in4_data[i * stride_0_0 +
                             in4_size[0] * (static_cast<int32_T>(in6) - 1)] -
  ...
  for (int32_T i{0}; i < b_loop_ub; i++) {
    b_in9_data[i] = static_cast<real_T>(in9_data[i * stride_0_0]) -
                    static_cast<real_T>(in10_data[i * stride_1_0]);
  }
  st.site = const_cast<emlrtRSInfo *>(&in1);
  coder::qrupdate(st, in2_data, in2_size, in3_data, in3_size, b_in4_data,
                  loop_ub, b_in9_data, b_loop_ub);
}
        ...
        int32_T T_size[2], real_T *niter)
{
  ...
  static const char_T cv3[46]{'I', 'n', 't', 'e', 'r', 'p', 'o', 'l', 'a', 't',
                              'i', 'o', 'n', ' ', 'm', 'a', 't', 'r', 'i', 'x',
                              ' ', 'e', 'n', 't', 'r', 'y', ' ', 'b', 'o', 'u',
                              'n', 'd', ' ', 'm', 'u', 's', 't', ' ', 'b', 'e',
                              ' ', '>', '=', ' ', '1', '.'};
  static const char_T cv1[38]{'R', 'a', 'n', 'k', ' ', 'o', 'r', ' ', 't', 'o',
                              'l', 'e', 'r', 'a', 'n', 'c', 'e', ' ', 'm', 'u',
                              's', 't', ' ', 'b', 'e', ' ', 'n', 'o', 'n', 'n',
                              'e', 'g', 'a', 't', 'i', 'v', 'e', '.'};
  ...
  static const char_T cv4[23]{'F', 'L', 'A', 'M', ':', 'i', 'd', ':',
                              'i', 'n', 'v', 'a', 'l', 'i', 'd', 'R',
                              'R', 'Q', 'R', 'I', 't', 'e', 'r'};
  static const char_T cv2[19]{'F', 'L', 'A', 'M', ':', 'i', 'd', ':', 'i', 'n',
                              'v', 'a', 'l', 'i', 'd', 'T', 'm', 'a', 'x'};
  emlrtStack b_st;
  emlrtStack c_st;
  emlrtStack d_st;
  ...
  //     A of rank K = MIN(KMAX,RANK(A)) via the skeleton and redundant indices
  //     SK and RD, respectively, and an interpolation matrix T such that
  ...
  //     1 and TOL = RANK_OR_TOL if RANK_OR_TOL < 1. More generally, both
  //     criteria can be specified simultaneously by letting RANK_OR_TOL = KMAX
  //     + TOL, with the approximation terminating as soon as either is reached.
  //
  //     [SK,RD,T] = ID(A,RANK_OR_TOL,TMAX) iteratively refines the
  //     approximation using rank-revealing QR column swaps until 1 <=
  //     MAX(ABS(T(:))) <= TMAX. Ignored if TMAX = INF (default: TMAX = 2).
  //     Refinement can improve numerical stability and reduce the output rank.
  //
  ...
  //     of refinement iterations performed.
  //
  //     [SK,RD,T,...] = ID(A,RANK_OR_TOL,TMAX,RRQR_ITER,FIXED) forces the
  //     indices in FIXED to be included in SK (default: FIXED = []). An ID is
  //     computed on the residual free columns then reconstituted along with the
  //     fixed ones. The parameters TMAX and RRQR_ITER apply only to this
  //     residual ID. If KMAX = FLOOR(RANK_OR_TOL) > 0 and LENGTH(FIXED) >=
  //     KMAX, then SK = FIXED.
  //
  //     References:
  //
  ...
  *niter = 0.0;
  ...
  if (b_k < 1.0) {
    ...
    if (b_k > 5.0) {
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1, 5, &emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
  ...
  if (b_k + 1.0 > 5.0) {
    ...
    if ((static_cast<int32_T>(b_k + 1.0) < 1) ||
        (static_cast<int32_T>(b_k + 1.0) > 5)) {
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k + 1.0), 1, 5,
  ...
  if (b_k < 1.0) {
    ...
    e_loop_ub = static_cast<int32_T>(b_k);
  }
  if (b_k + 1.0 > 5.0) {
    i2 = 0;
    i3 = 0;
  ...
  st.site = &db_emlrtRSI;
  coder::mldivide(st, Q, b_R_size, b_R_data, c_R_size, R, y_size);
  c_k[0] = e_loop_ub;
  k_tmp = i3 - i2;
  c_k[1] = k_tmp;
  ...
  if ((!muDoubleScalarIsInf(Tmax)) && (rrqr_iter > 0.0) && (b_k > 0.0) &&
    ...
    if (b_loop_ub + 1 > loop_ub) {
      ...
      if (b_loop_ub + 1 > loop_ub) {
        emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k) + 1, 1, loop_ub,
    ...
    st.site = &bb_emlrtRSI;
    coder::power(tmp_data, d_R_size, R, y_size);
    st.site = &bb_emlrtRSI;
    coder::sum(st, R, y_size, u_data, b_R_size);
    c2_size[0] = 1;
    c_loop_ub = b_R_size[1];
    c2_size[1] = b_R_size[1];
    if (c_loop_ub - 1 >= 0) {
      std::copy(&u_data[0], &u_data[c_loop_ub], &c2_data[0]);
    }
    ...
    st.site = &ab_emlrtRSI;
    coder::inv(st, c_R_data, e_R_size, b_tmp_data, d_R_size);
    st.site = &ab_emlrtRSI;
    coder::power(b_tmp_data, d_R_size, R, y_size);
    st.site = &ab_emlrtRSI;
    r2_size = coder::sum(R, y_size, r2_data);
    ...
    while ((!exitg1) && (*niter < rrqr_iter)) {
      ...
      if (b_k < 1.0) {
        ...
        if (static_cast<int32_T>(b_k) > R_size[0]) {
          emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1, R_size[0],
                                        &n_emlrtBCI, (emlrtConstCTX)sp);
        }
        loop_ub = static_cast<int32_T>(b_k);
      }
      tmp_size[0] = loop_ub;
      loop_ub_tmp = 5 - static_cast<int32_T>(b_k);
      tmp_size[1] = 5 - static_cast<int32_T>(b_k);
      b_loop_ub_tmp = -static_cast<int32_T>(b_k);
      for (i = 0; i <= b_loop_ub_tmp + 4; i++) {
        for (i1 = 0; i1 < loop_ub; i1++) {
          tmp_data[i1 + loop_ub * i] =
              R_data[i1 + R_size[0] * (static_cast<int32_T>(b_k) + i)];
        }
      }
      st.site = &y_emlrtRSI;
      coder::power(tmp_data, tmp_size, R, y_size);
      e_loop_ub = y_size[0];
      tmp_size[0] = y_size[0];
      k_tmp = y_size[1];
      tmp_size[1] = y_size[1];
      ...
      e_loop_ub =
          coder::b_abs(tmp_data, tmp_size[0] * tmp_size[1], varargin_1_data);
      ...
      if (kmax <= f2) {
        ...
        k_tmp =
            coder::internal::ind2sub(c_st, d_k, static_cast<real_T>(idx), k);
        //  need to swap i-th and (k+j)-th columns
        //  swap i-th and k-th columns
        if (k_tmp < static_cast<int32_T>(b_k)) {
          real_T e_tmp_data[8];
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > 5)) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1, 5,
          ...
          e_loop_ub = p[k_tmp - 1];
          p[k_tmp - 1] = p[static_cast<int32_T>(b_k) - 1];
          p[static_cast<int32_T>(b_k) - 1] = e_loop_ub;
          if (b_k < 1.0) {
            loop_ub = 0;
            b_loop_ub = 0;
            c_loop_ub = 0;
          ...
          b_tmp_size[0] = 1;
          b_tmp_size[1] = static_cast<int32_T>(b_k);
          for (i1 = 0; i1 < d_loop_ub; i1++) {
            c_tmp_data[i1] = (i1 + 1 == k_tmp);
          }
          c_tmp_size[0] = 1;
          c_tmp_size[1] = static_cast<int32_T>(b_k - 1.0) + 1;
          e_loop_ub = static_cast<int32_T>(b_k - 1.0);
          for (i1 = 0; i1 <= e_loop_ub; i1++) {
            d_tmp_data[i1] = (static_cast<real_T>(i1) + 1.0 == b_k);
          }
          if ((static_cast<int32_T>(b_k) !=
               static_cast<int32_T>(b_k - 1.0) + 1) &&
          ...
          st.site = &v_emlrtRSI;
          coder::eye(st, b_k, c_R_data, e_R_size);
          d_R_size[0] = loop_ub;
          ...
          if ((c_loop_ub == i) && (static_cast<int32_T>(b_k) ==
                                   static_cast<int32_T>(b_k - 1.0) + 1)) {
            scalarLB = (c_loop_ub / 2) << 1;
            vectorUB = scalarLB - 2;
            for (i = 0; i <= vectorUB; i += 2) {
              r = _mm_loadu_pd(
                  &R_data[i + R_size[0] * (static_cast<int32_T>(b_k) - 1)]);
            ...
            st.site = &v_emlrtRSI;
            coder::qrupdate(st, c_R_data, e_R_size, b_tmp_data, d_R_size,
                            g_R_data, c_loop_ub, r_data,
          ...
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                          R_size[0], &u_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          ...
          for (i = 0; i < d_loop_ub; i++) {
            for (i1 = 0; i1 < d_loop_ub; i1++) {
              R_data[i1 + R_size[0] * i] =
                  b_tmp_data[i1 + static_cast<int32_T>(b_k) * i];
            }
          }
          if (k_tmp > R_size[0]) {
          ...
          if ((static_cast<int8_T>(static_cast<int32_T>(b_k)) < 1) ||
              (static_cast<int8_T>(static_cast<int32_T>(b_k)) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(
                static_cast<int32_T>(
                    static_cast<int8_T>(static_cast<int32_T>(b_k))),
                1, R_size[0], &ie_emlrtBCI, (emlrtConstCTX)sp);
          }
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                          R_size[0], &je_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          if (k_tmp > R_size[0]) {
          ...
          for (i = 0; i <= b_loop_ub_tmp + 4; i++) {
            e_loop_ub = R_size[0] * (static_cast<int32_T>(b_k) + i);
            e_tmp_data[2 * i] =
                R_data[(static_cast<int32_T>(b_k) + e_loop_ub) - 1];
            e_tmp_data[2 * i + 1] = R_data[(k_tmp + e_loop_ub) - 1];
          }
          c_k[0] = 2;
          c_k[1] = 5 - static_cast<int32_T>(b_k);
          b_R_size[0] = 2;
          b_R_size[1] = 5 - static_cast<int32_T>(b_k);
          emlrtSubAssignSizeCheckR2012b(&c_k[0], 2, &b_R_size[0], 2,
                                        &g_emlrtECI, (emlrtCTX)sp);
          for (i = 0; i < loop_ub_tmp; i++) {
            e_loop_ub = R_size[0] * (static_cast<int32_T>(b_k) + i);
            R_data[(k_tmp + e_loop_ub) - 1] = e_tmp_data[2 * i];
            R_data[static_cast<int8_T>(
                       static_cast<int8_T>(static_cast<int32_T>(b_k)) - 1) +
                   e_loop_ub] = e_tmp_data[2 * i + 1];
          }
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > r2_size)) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1, r2_size,
          ...
          r2_data[k_tmp - 1] = r2_data[static_cast<int32_T>(b_k) - 1];
          r2_data[static_cast<int32_T>(b_k) - 1] = d_k[1];
        }
        ...
        if (k > 1) {
          ...
          d_k[0] = static_cast<int32_T>(b_k + 1.0);
          i = static_cast<int32_T>(b_k + static_cast<real_T>(k));
          if ((i < 1) || (i > 5)) {
            emlrtDynamicBoundsCheckR2012b(i, 1, 5, &de_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          d_k[1] = i;
          i1 = static_cast<int8_T>(static_cast<uint32_T>(b_k) +
                                   static_cast<uint32_T>(k));
          if ((i1 < 1) || (i1 > 5)) {
            emlrtDynamicBoundsCheckR2012b(i1, 1, 5, &ee_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          b_iv[0] = static_cast<int8_T>(i1);
          if ((static_cast<int8_T>(static_cast<int32_T>(b_k) + 1) < 1) ||
              (static_cast<int8_T>(static_cast<int32_T>(b_k) + 1) > 5)) {
            emlrtDynamicBoundsCheckR2012b(
                static_cast<int32_T>(
                    static_cast<int8_T>(static_cast<int32_T>(b_k) + 1)),
                1, 5, &ee_emlrtBCI, (emlrtConstCTX)sp);
          }
          b_iv[1] = static_cast<int8_T>(static_cast<int32_T>(b_k) + 1);
          c_k[1] = p[static_cast<int8_T>(static_cast<int32_T>(b_k) + 1) - 1];
          p[static_cast<int32_T>(b_k + 1.0) - 1] = p[i1 - 1];
          p[i - 1] = c_k[1];
          e_loop_ub = R_size[0];
          b_R_size[0] = R_size[0];
          b_R_size[1] = 2;
          ...
          for (i = 0; i < 2; i++) {
            for (i1 = 0; i1 < e_loop_ub; i1++) {
              R_data[i1 + R_size[0] * (static_cast<int32_T>(d_k[i]) - 1)] =
                  f_R_data[i1 + k_tmp * i];
            }
          }
          if (k > c2_size[1]) {
        ...
        if (b_k - 1.0 < 1.0) {
          ...
          if ((static_cast<int32_T>(b_k) - 1 < 1) ||
              (static_cast<int32_T>(b_k) - 1 > r2_size)) {
        ...
        c_k[1] = loop_ub;
        st.site = &u_emlrtRSI;
        coder::internal::indexShapeCheck(st, r2_size, c_k);
        if (b_k - 1.0 < 1.0) {
          b_loop_ub = 0;
          c_loop_ub = 0;
          d_loop_ub = 0;
          ...
          if ((static_cast<int32_T>(b_k) - 1 < 1) ||
              (static_cast<int32_T>(b_k) - 1 > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k) - 1, 1,
                                          R_size[0], &y_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          ...
          if ((static_cast<int32_T>(b_k) - 1 < 1) ||
              (static_cast<int32_T>(b_k) - 1 > 5)) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k) - 1, 1, 5,
          ...
          if ((static_cast<int32_T>(b_k) - 1 < 1) ||
              (static_cast<int32_T>(b_k) - 1 > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k) - 1, 1,
                                          R_size[0], &bb_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          d_loop_ub = static_cast<int32_T>(b_k) - 1;
        }
        if ((static_cast<int32_T>(b_k) < 1) ||
            (static_cast<int32_T>(b_k) > 5)) {
          emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1, 5,
        ...
        for (i = 0; i < d_loop_ub; i++) {
          e_R_data[i] = R_data[i + R_size[0] * (static_cast<int32_T>(b_k) - 1)];
        }
        st.site = &u_emlrtRSI;
        k = coder::mldivide(st, d_R_data, f_R_size, e_R_data, d_loop_ub,
                            v_data);
        b_loop_ub = R_size[0];
        if ((static_cast<int32_T>(b_k) < 1) ||
            (static_cast<int32_T>(b_k) > R_size[0])) {
        ...
        b_R_tmp_tmp = R_size[0] * (static_cast<int32_T>(b_k) - 1);
        c_R_tmp_tmp = static_cast<int32_T>(b_k) + b_R_tmp_tmp;
        ...
        st.site = &u_emlrtRSI;
        e_loop_ub = coder::b_abs(e_R_data, k, varargin_1_data);
        st.site = &u_emlrtRSI;
        k_tmp = coder::power(varargin_1_data, e_loop_ub, e_R_data);
        ...
        if (c_loop_ub - 1 >= 0) {
          std::copy(&e_R_data[0], &e_R_data[c_loop_ub], &r2_data[0]);
        }
        if ((static_cast<int32_T>(b_k) < 1) ||
            (static_cast<int32_T>(b_k) > r2_size)) {
          emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1, r2_size,
        ...
        if (R_size[0] == static_cast<int32_T>(b_k)) {
          //  no trailing R22 -- typical for fixed-precision case
          u_size = R_size[0];
          for (i = 0; i < b_loop_ub; i++) {
            u_data[i] = R_data[i + R_size[0] * static_cast<int32_T>(b_k)];
          }
          //  for rank-one update of T
          st.site = &t_emlrtRSI;
          e_R_size[0] = R_size[0];
          loop_ub = static_cast<int32_T>(b_k);
          e_R_size[1] = static_cast<int32_T>(b_k);
          for (i = 0; i < loop_ub; i++) {
            for (i1 = 0; i1 < b_loop_ub; i1++) {
          ...
          for (i = 0; i < b_loop_ub; i++) {
            r_data[i] = R_data[i + R_size[0] * static_cast<int32_T>(b_k)];
          }
          c_st.site = &ng_emlrtRSI;
          coder::dynamic_size_checks(c_st, e_R_size, R_size[0],
                                     static_cast<int32_T>(b_k), R_size[0]);
          c_st.site = &mg_emlrtRSI;
          k = coder::internal::blas::mtimes(c_R_data, e_R_size, r_data,
                                            R_size[0], v_data);
          emlrtSubAssignSizeCheckR2012b(&R_size[0], 1, &k, 1, &k_emlrtECI,
                                        (emlrtCTX)sp);
          for (i = 0; i < b_loop_ub; i++) {
            R_data[i + R_size[0] * static_cast<int32_T>(b_k)] = v_data[i];
          }
          if (b_k - 1.0 < 1.0) {
            loop_ub = 0;
          } else {
          ...
          if (loop_ub - 1 >= 0) {
            std::memset(
                &R_data[b_R_tmp_tmp], 0,
                static_cast<uint32_T>((loop_ub + b_R_tmp_tmp) - b_R_tmp_tmp) *
                    sizeof(real_T));
          }
          ...
          if (static_cast<int32_T>(b_k) + 1 > R_size[0]) {
            i = 0;
            i1 = 0;
          } else {
            if ((static_cast<int32_T>(b_k) + 1 < 1) ||
          ...
          for (i1 = 0; i1 < loop_ub; i1++) {
            v_data[i1] =
                R_data[(i + i1) + R_size[0] * static_cast<int32_T>(b_k)];
          }
          ...
          b_loop_ub = static_cast<int32_T>(b_k);
          i1 = R_size[0] * static_cast<int32_T>(b_k);
          i2 = static_cast<int32_T>(b_k) + i1;
          R_tmp_tmp = muDoubleScalarAtan2(0.0, R_data[i2]);
          dc.re = R_tmp_tmp * 0.0;
          dc.im = R_tmp_tmp;
          coder::b_exp(dc);
          v_data[0] = R_data[i + i1] + muDoubleScalarSqrt(c2_data[0]) * dc.re;
          R_tmp_tmp = coder::b_norm(v_data, loop_ub);
          idx = (loop_ub / 2) << 1;
          vectorUB = idx - 2;
          for (i = 0; i <= vectorUB; i += 2) {
            r = _mm_loadu_pd(&v_data[i]);
          ...
          if (b_k + 2.0 > 5.0) {
            ...
            if ((static_cast<int32_T>(b_k) + 2 < 1) ||
                (static_cast<int32_T>(b_k) + 2 > 5)) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k) + 2, 1, 5,
          ...
          if (static_cast<int32_T>(b_k) + 1 > R_size[0]) {
            ...
            if ((static_cast<int32_T>(b_k) + 1 < 1) ||
                (static_cast<int32_T>(b_k) + 1 > R_size[0])) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k) + 1, 1,
                                            R_size[0], &ob_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            i5 = static_cast<int32_T>(b_k);
            if (R_size[0] < 1) {
              emlrtDynamicBoundsCheckR2012b(R_size[0], 1, R_size[0],
          ...
          c_st.site = &ng_emlrtRSI;
          coder::dynamic_size_checks(c_st, loop_ub, y_size, loop_ub, c_loop_ub);
          c_st.site = &mg_emlrtRSI;
          coder::internal::blas::mtimes(v_data, loop_ub, R, y_size, s_data,
                                        c_R_size);
          y_size[0] = loop_ub;
          ...
          if (static_cast<int32_T>(b_k) + 2 > R_size[0]) {
            i = 0;
            i3 = 0;
          } else {
            if ((static_cast<int32_T>(b_k) + 2 < 1) ||
                (static_cast<int32_T>(b_k) + 2 > R_size[0])) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k) + 2, 1,
                                            R_size[0], &ub_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
          ...
          loop_ub = i3 - i;
          if (loop_ub - 1 >= 0) {
            std::memset(&R_data[i + i1], 0,
                        static_cast<uint32_T>((((loop_ub + i) + i1) - i) - i1) *
                            sizeof(real_T));
          }
          if ((static_cast<int32_T>(b_k) + 1 < 1) ||
              (static_cast<int32_T>(b_k) + 1 > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k) + 1, 1,
                                          R_size[0], &ne_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          R_data[i2] = c2_data[0];
          if ((static_cast<int32_T>(b_k) + 1 < 1) ||
          ...
          *x = muDoubleScalarSqrt(*x);
          ...
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                          R_size[0], &xb_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                          R_size[0], &yb_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                          R_size[0], &ac_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          st.site = &p_emlrtRSI;
          e_R_size[0] = static_cast<int32_T>(b_k);
          e_R_size[1] = static_cast<int32_T>(b_k);
          for (i = 0; i < b_loop_ub; i++) {
            for (i3 = 0; i3 < b_loop_ub; i3++) {
              c_R_data[i3 + static_cast<int32_T>(b_k) * i] =
                  R_data[i3 + R_size[0] * i];
            }
            r_data[i] = R_data[i + i1];
          }
          c_st.site = &ng_emlrtRSI;
          coder::dynamic_size_checks(c_st, e_R_size, static_cast<int32_T>(b_k),
                                     static_cast<int32_T>(b_k),
                                     static_cast<int32_T>(b_k));
          c_st.site = &mg_emlrtRSI;
          k = coder::internal::blas::mtimes(c_R_data, e_R_size, r_data,
                                            static_cast<int32_T>(b_k), v_data);
          ...
          if (b_k + 2.0 > 5.0) {
            ...
            i = static_cast<int32_T>(b_k) + 1;
            i3 = 5;
            i4 = static_cast<int32_T>(b_k) + 1;
            k_idx_1_tmp = 5;
          }
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                          R_size[0], &cc_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                          R_size[0], &re_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          kmax = R_data[c_R_tmp_tmp - 1];
          c_R_size[0] = 1;
          ...
          for (i3 = 0; i3 < loop_ub; i3++) {
            s_data[i3] =
                kmax *
                R_data[(static_cast<int32_T>(b_k) + R_size[0] * (i + i3)) - 1];
          }
          c_k[0] = 1;
          ...
          for (i = 0; i < k_tmp; i++) {
            R_data[(static_cast<int32_T>(b_k) + R_size[0] * (i4 + i)) - 1] =
                s_data[i];
          }
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                          R_size[0], &dc_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          for (i = 0; i < b_loop_ub; i++) {
          ...
          if ((static_cast<int32_T>(b_k) + 1 < 1) ||
              (static_cast<int32_T>(b_k) + 1 > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k) + 1, 1,
                                          R_size[0], &fc_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          g_R_size[0] = 1;
          g_R_size[1] = 5 - static_cast<int32_T>(b_k);
          for (i = 0; i <= b_loop_ub_tmp + 4; i++) {
            g_R_data[i] = R_data[static_cast<int32_T>(b_k) +
                                 R_size[0] * (static_cast<int32_T>(b_k) + i)];
          }
          st.site = &o_emlrtRSI;
          coder::b_abs(g_R_data, g_R_size, u_data, b_R_size);
          st.site = &o_emlrtRSI;
          coder::b_power(u_data, b_R_size, g_R_data, g_R_size);
          ...
          if ((static_cast<int32_T>(b_k + 1.0) < 1) ||
              (static_cast<int32_T>(b_k + 1.0) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k + 1.0), 1,
                                          R_size[0], &gc_emlrtBCI, &st);
          }
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                          R_size[0], &ff_emlrtBCI, &st);
          }
          if ((static_cast<int32_T>(b_k + 1.0) < 1) ||
              (static_cast<int32_T>(b_k + 1.0) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k + 1.0), 1,
          ...
          h_R_size[0] = 2;
          k = 6 - static_cast<int32_T>(b_k);
          h_R_size[1] = 6 - static_cast<int32_T>(b_k);
          for (i = 0; i <= b_loop_ub_tmp + 5; i++) {
            e_loop_ub = R_size[0] * ((static_cast<int32_T>(b_k) + i) - 1);
            f_R_data[2 * i] =
                R_data[(static_cast<int32_T>(b_k) + e_loop_ub) - 1];
            f_R_data[2 * i + 1] =
                R_data[(static_cast<int32_T>(b_k + 1.0) + e_loop_ub) - 1];
          }
          givens_id(R_data[i2 - 1], R_data[i2], u_data);
          c_st.site = &mg_emlrtRSI;
          coder::internal::blas::mtimes(u_data, f_R_data, h_R_size, f_tmp_data,
                                        b_R_size);
          c_k[0] = 2;
          c_k[1] = 6 - static_cast<int32_T>(b_k);
          emlrtSubAssignSizeCheckR2012b(&c_k[0], 2, &b_R_size[0], 2,
          ...
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                          R_size[0], &we_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          R_tmp_tmp = r_data[static_cast<int32_T>(b_k) - 1];
          R_data[c_R_tmp_tmp - 1] = R_tmp_tmp;
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                          R_size[0], &jc_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                          R_size[0], &kc_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          e_R_size[0] = static_cast<int32_T>(b_k);
          e_R_size[1] = static_cast<int32_T>(b_k);
          for (i = 0; i < b_loop_ub; i++) {
            for (i2 = 0; i2 < b_loop_ub; i2++) {
              c_R_data[i2 + static_cast<int32_T>(b_k) * i] =
                  R_data[i2 + R_size[0] * i];
            }
            g_R_data[i] = R_data[i + i1];
          }
          st.site = &k_emlrtRSI;
          u_size = coder::mldivide(st, c_R_data, e_R_size, g_R_data,
                                   static_cast<int32_T>(b_k), u_data);
          //  for rank-one update of T
          if ((static_cast<int32_T>(b_k) < 1) ||
              (static_cast<int32_T>(b_k) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                          R_size[0], &ye_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          ...
          if (b_k - 1.0 < 1.0) {
            ...
            c_loop_ub = static_cast<int32_T>(b_k) - 1;
            if ((static_cast<int32_T>(b_k) - 1 < 1) ||
                (static_cast<int32_T>(b_k) - 1 > static_cast<int32_T>(b_k))) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k) - 1, 1,
                                            static_cast<int32_T>(b_k),
          ...
          c_k[1] = d_loop_ub;
          st.site = &j_emlrtRSI;
          coder::internal::indexShapeCheck(st, static_cast<int32_T>(b_k), c_k);
          f_R_size[0] = b_loop_ub;
          f_R_size[1] = c_loop_ub;
          for (i = 0; i < c_loop_ub; i++) {
            for (i1 = 0; i1 < b_loop_ub; i1++) {
          ...
          if (d_loop_ub - 1 >= 0) {
            std::copy(&r_data[0], &r_data[d_loop_ub], &e_R_data[0]);
          }
          st.site = &j_emlrtRSI;
          k = coder::mldivide(st, d_R_data, f_R_size, e_R_data, d_loop_ub,
                              v_data);
          ...
          if (loop_ub == i4) {
            ...
            y_size[1] = loop_ub;
            for (i3 = 0; i3 < loop_ub; i3++) {
              s_data[i3] -= R_data[(static_cast<int32_T>(b_k) +
                                    R_size[0] * ((i2 + i3) + 1)) -
                                   1];
              scalarLB = (k / 2) << 1;
              vectorUB = scalarLB - 2;
          ...
          for (i1 = 0; i1 < loop_ub; i1++) {
            s_data[i1] =
                R_data[(static_cast<int32_T>(b_k) + R_size[0] * (i + i1)) - 1] /
                R_tmp_tmp;
          }
          c_k[0] = 1;
          k_tmp = i3 - i2;
          ...
          for (i = 0; i < k_tmp; i++) {
            R_data[(static_cast<int32_T>(b_k) + R_size[0] * (i2 + i)) - 1] =
                s_data[i];
          }
        }
        //  swap k-th and (k+1)-th columns; update inverse row norms
        k_idx_1_tmp = static_cast<int32_T>(b_k - 1.0);
        e_loop_ub = p[static_cast<int32_T>(b_k - 1.0)];
        p[static_cast<int32_T>(b_k - 1.0)] =
            p[static_cast<int32_T>((b_k + 1.0) - 1.0)];
        p[static_cast<int32_T>((b_k + 1.0) - 1.0)] = e_loop_ub;
        e_loop_ub = R_size[0];
        b_R_size[0] = R_size[0];
        b_R_size[1] = 2;
        c_k[0] = R_size[0];
        ...
        emlrtSubAssignSizeCheckR2012b(&b_R_size[0], 2, &c_k[0], 2, &ab_emlrtECI,
                                      (emlrtCTX)sp);
        c_k[0] = static_cast<int32_T>((b_k + 1.0) - 1.0);
        c_k[1] = static_cast<int32_T>(b_k - 1.0);
        b_R_size[0] = static_cast<int32_T>(b_k - 1.0);
        b_R_size[1] = static_cast<int32_T>((b_k + 1.0) - 1.0);
        k_tmp = R_size[0];
        for (i = 0; i < 2; i++) {
          for (i1 = 0; i1 < e_loop_ub; i1++) {
        ...
        if (b_loop_ub - 1 >= 0) {
          std::copy(&e_R_data[0], &e_R_data[b_loop_ub], &r2_data[0]);
        }
        st.site = &h_emlrtRSI;
        loop_ub = static_cast<int32_T>(b_k);
        ...
        r2_data[static_cast<int32_T>(b_k) - 1] = 1.0 / (kmax * kmax);
        //  finish update of T by Sherman-Morrison
        if ((static_cast<int32_T>(b_k) < 1) ||
            (static_cast<int32_T>(b_k) > u_size)) {
          emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1, u_size,
                                        &pe_emlrtBCI, (emlrtConstCTX)sp);
        }
        u_data[static_cast<int32_T>(b_k) - 1]--;
        if (R_size[0] < 1) {
        ...
        R_tmp_tmp = u_data[static_cast<int32_T>(b_k) - 1] + 1.0;
        d_R_size[0] = u_size;
        d_R_size[1] = 5 - static_cast<int32_T>(b_k);
        for (i = 0; i <= b_loop_ub_tmp + 4; i++) {
          scalarLB = (u_size / 2) << 1;
          vectorUB = scalarLB - 2;
          for (i1 = 0; i1 <= vectorUB; i1 += 2) {
                ...
                _mm_div_pd(
                    _mm_add_pd(
                        ...
                        _mm_mul_pd(
                            r,
                            _mm_set1_pd(
                                R_data[(static_cast<int32_T>(b_k) +
                                        R_size[0] *
        ...
        if ((static_cast<int32_T>(b_k) != u_size) &&
            ((static_cast<int32_T>(b_k) != 1) && (u_size != 1))) {
          emlrtDimSizeImpxCheckR2021b(static_cast<int32_T>(b_k), u_size,
        ...
        if (static_cast<int32_T>(b_k) == u_size) {
          d_R_size[0] = static_cast<int32_T>(b_k);
          d_R_size[1] = 5 - static_cast<int32_T>(b_k);
          for (i = 0; i <= b_loop_ub_tmp + 4; i++) {
            scalarLB = (static_cast<int32_T>(b_k) / 2) << 1;
            vectorUB = scalarLB - 2;
            for (i1 = 0; i1 <= vectorUB; i1 += 2) {
              r = _mm_loadu_pd(
                  &R_data[i1 + R_size[0] * (static_cast<int32_T>(b_k) + i)]);
              i2 = i1 + static_cast<int32_T>(b_k) * i;
              r1 = _mm_loadu_pd(&b_tmp_data[i2]);
              _mm_storeu_pd(&b_tmp_data[i2], _mm_sub_pd(r, r1));
            }
            for (i1 = scalarLB; i1 < loop_ub; i1++) {
              e_loop_ub = i1 + static_cast<int32_T>(b_k) * i;
        ...
        c_k[0] = static_cast<int32_T>(b_k);
        e_loop_ub = static_cast<int32_T>(5.0 - ((b_k + 1.0) - 1.0));
        c_k[1] = static_cast<int32_T>(5.0 - ((b_k + 1.0) - 1.0));
        ...
        k_tmp = r2_size;
        if (r2_size - 1 >= 0) {
          std::copy(&r2_data[0], &r2_data[r2_size], &r_data[0]);
        }
        st.site = &g_emlrtRSI;
        coder::b_sqrt(st, r_data, k_tmp);
        scalarLB = (k_tmp / 2) << 1;
        vectorUB = scalarLB - 2;
        for (i = 0; i <= vectorUB; i += 2) {
        ...
        if (!(kmax > tol)) {
          ...
          if (idx < static_cast<int32_T>(b_k)) {
            ...
            if ((static_cast<int32_T>(b_k) < 1) ||
                (static_cast<int32_T>(b_k) > R_size[0])) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                            R_size[0], &id_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            if ((static_cast<int32_T>(b_k) < 1) ||
                (static_cast<int32_T>(b_k) > R_size[0])) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                            R_size[0], &jd_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            if ((static_cast<int32_T>(b_k) < 1) ||
                (static_cast<int32_T>(b_k) > R_size[0])) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                            R_size[0], &kd_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            b_tmp_size[0] = 1;
            b_tmp_size[1] = static_cast<int32_T>(b_k);
            ...
            for (i = 0; i <= k_idx_1_tmp; i++) {
              d_tmp_data[i] = (static_cast<real_T>(i) + 1.0 == b_k);
            }
            if ((static_cast<int32_T>(b_k) !=
                 static_cast<int32_T>(b_k - 1.0) + 1) &&
                ((static_cast<int32_T>(b_k) != 1) &&
            ...
            coder::eye(st, b_k, c_R_data, e_R_size);
            d_R_size[0] = static_cast<int32_T>(b_k);
            d_R_size[1] = static_cast<int32_T>(b_k);
            for (i = 0; i < loop_ub; i++) {
              for (i1 = 0; i1 < loop_ub; i1++) {
                b_tmp_data[i1 + static_cast<int32_T>(b_k) * i] =
                    R_data[i1 + R_size[0] * i];
            ...
            if (static_cast<int32_T>(b_k) ==
              ...
              st.site = &f_emlrtRSI;
              coder::qrupdate(st, c_R_data, e_R_size, b_tmp_data, d_R_size,
                              g_R_data, static_cast<int32_T>(b_k), r_data,
                              static_cast<int32_T>(b_k));
            } else {
              st.site = &f_emlrtRSI;
              binary_expand_op_2(st, f_emlrtRSI, c_R_data, e_R_size, b_tmp_data,
                                 d_R_size, R_data, R_size, b_k, idx, c_tmp_data,
                                 b_tmp_size, d_tmp_data, c_tmp_size);
            }
            if ((static_cast<int32_T>(b_k) < 1) ||
                (static_cast<int32_T>(b_k) > R_size[0])) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                            R_size[0], &ld_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            c_k[0] = static_cast<int32_T>(b_k);
            c_k[1] = static_cast<int32_T>(b_k);
            ...
            if ((static_cast<int8_T>(b_k) < 1) ||
                (static_cast<int8_T>(b_k) > R_size[0])) {
              emlrtDynamicBoundsCheckR2012b(
                  static_cast<int32_T>(static_cast<int8_T>(b_k)), 1, R_size[0],
                  &se_emlrtBCI, (emlrtConstCTX)sp);
            }
            if ((static_cast<int32_T>(b_k) < 1) ||
                (static_cast<int32_T>(b_k) > R_size[0])) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                            R_size[0], &ue_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
            if (idx > R_size[0]) {
            ...
            for (i = 0; i < loop_ub_tmp; i++) {
              e_loop_ub = R_size[0] * (static_cast<int32_T>(b_k) + i);
              R_data[static_cast<int8_T>(idx - 1) + e_loop_ub] =
                  g_tmp_data[2 * i];
              R_data[static_cast<int8_T>(static_cast<int8_T>(b_k) - 1) +
                     e_loop_ub] = g_tmp_data[2 * i + 1];
            }
            if ((static_cast<int32_T>(b_k) < 1) ||
                (static_cast<int32_T>(b_k) > r2_size)) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
            ...
            d_k[1] = r2_data[idx - 1];
            r2_data[idx - 1] = r2_data[static_cast<int32_T>(b_k) - 1];
            r2_data[static_cast<int32_T>(b_k) - 1] = d_k[1];
          }
          //  decrease rank from k to k-1
          c2_size[0] = 1;
          loop_ub_tmp = 6 - static_cast<int32_T>(b_k);
          c2_size[1] = 6 - static_cast<int32_T>(b_k);
          if (loop_ub_tmp - 1 >= 0) {
            std::memset(&c2_data[0], 0,
          ...
          st.site = &d_emlrtRSI;
          k_tmp = coder::mldivide(st, d_R_data, f_R_size, e_R_data, c_loop_ub,
                                  r_data);
          if (b_k < 1.0) {
            loop_ub = 0;
          } else {
          ...
          if ((static_cast<int32_T>(b_k + 1.0) < 1) ||
              (static_cast<int32_T>(b_k + 1.0) > R_size[0])) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k + 1.0), 1,
                                          R_size[0], &ud_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          y_size[0] = k_tmp;
          loop_ub_tmp = 4 - static_cast<int32_T>(b_k);
          y_size[1] = 4 - static_cast<int32_T>(b_k);
          for (i = 0; i < loop_ub_tmp; i++) {
            scalarLB = (k_tmp / 2) << 1;
            vectorUB = scalarLB - 2;
            for (i1 = 0; i1 <= vectorUB; i1 += 2) {
              ...
              _mm_storeu_pd(
                  ...
                  _mm_mul_pd(
                      ...
                      _mm_set1_pd(
                          R_data[k_idx_1_tmp +
                                 R_size[0] *
                                     ((static_cast<int32_T>(b_k) + i) + 1)])));
            }
            for (i1 = scalarLB; i1 < k_tmp; i1++) {
              R[i1 + k_tmp * i] =
                  r_data[i1] *
                  R_data[k_idx_1_tmp +
                         R_size[0] * ((static_cast<int32_T>(b_k) + i) + 1)];
            }
          }
          if ((loop_ub != k_tmp) && ((loop_ub != 1) && (k_tmp != 1))) {
          ...
          if (loop_ub == k_tmp) {
            ...
            varargin_2_size[1] = 4 - static_cast<int32_T>(b_k);
            for (i = 0; i < loop_ub_tmp; i++) {
              scalarLB = (loop_ub / 2) << 1;
              vectorUB = scalarLB - 2;
              for (i1 = 0; i1 <= vectorUB; i1 += 2) {
                r = _mm_loadu_pd(
                    &R_data[R_size[0] * ((static_cast<int32_T>(b_k) + i) + 1)]);
          ...
          if (empty_non_axis_sizes ||
              ((varargin_2_size[0] != 0) && (varargin_2_size[1] != 0))) {
            sizes_idx_1 = static_cast<int8_T>(varargin_2_size[1]);
          } else {
            sizes_idx_1 = 0;
          }
          ...
          if ((loop_ub - 1 >= 0) && (e_loop_ub - 1 >= 0)) {
            std::copy(&r_data[0], &r_data[e_loop_ub], &h_tmp_data[0]);
          }
          loop_ub = sizes_idx_1;
          for (i = 0; i < loop_ub; i++) {
            for (i1 = 0; i1 < e_loop_ub; i1++) {
          ...
          c_k[0] = b_loop_ub;
          k_tmp = 5 - static_cast<int32_T>(b_k);
          c_k[1] = 5 - static_cast<int32_T>(b_k);
          emlrtSubAssignSizeCheckR2012b(&c_k[0], 2, &d_tmp_size[0], 2,
          ...
          if (b_k < 1.0) {
            k_idx_1_tmp = 0;
          } else if (static_cast<int32_T>(b_k) > R_size[0]) {
            emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(b_k), 1,
                                          R_size[0], &wd_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          for (i = 0; i < 5; i++) {
    ...
    if (conv == 0) {
      ...
      coder::internal::WarningState::callWarning(c_st);
    }
  }
  //  set ID outputs
  if (b_k < 1.0) {
