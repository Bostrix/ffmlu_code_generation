            ...
            real_T R[25], int32_T E[5])
{
  ...
  for (int32_T i{0}; i < 5; i++) {
    ...
    if (pvt != i) {
      ...
      kend = static_cast<int8_T>(E[pvt]);
      E[pvt] = static_cast<int8_T>(E[i]);
      E[i] = kend;
      vn1[pvt] = vn1[i];
      vn2[pvt] = vn2[i];
    }
    if (i + 1 < 5) {
      ...
      smax = internal::blas::xnrm2(f_st, 4 - i, Q, ii + 2);
      if (smax != 0.0) {
        absxk = Q[ii];
        ...
        if (muDoubleScalarAbs(smax) < 1.0020841800044864E-292) {
          ...
          internal::blas::xscal(f_st, 4 - i, 1.0 / (scale - smax), Q, ii + 2);
          ...
          internal::blas::xscal(f_st, 4 - i, 1.0 / (Q[ii] - smax), Q, ii + 2);
          scale = smax;
        }
      }
      Q[ii] = 1.0;
      ...
      if (tau[i] != 0.0) {
        ...
        kend = internal::reflapack::ilazlc(f_st, lastv, 4 - i, Q, ii + 6);
      } else {
        lastv = 0;
        kend = 0;
      }
      if (lastv > 0) {
        ...
        internal::blas::xgemv(f_st, lastv, kend, Q, ii + 6, Q, ii + 1, work);
        f_st.site = &bc_emlrtRSI;
        internal::blas::xgerc(f_st, lastv, kend, -tau[i], ii + 1, work, Q,
                              ii + 6);
      }
      Q[ii] = scale;
    } else {
      ...
      if (absxk != 0.0) {
        ...
        if (scale <= 1.4901161193847656E-8) {
          if (i + 1 < 5) {
            ...
            absxk = internal::blas::xnrm2(e_st, 4 - i, Q, kend + 2);
            vn1[lastv - 1] = absxk;
            vn2[lastv - 1] = absxk;
          } else {
            vn1[lastv - 1] = 0.0;
  ...
  for (lastv = 0; lastv < 5; lastv++) {
    ...
    for (int32_T i{0}; i <= lastv; i++) {
      kend = i + 5 * lastv;
      R[kend] = Q[kend];
    }
    A_tmp = lastv + 2;
    if (A_tmp <= 5) {
      std::memset(&R[(lastv * 5 + A_tmp) + -1], 0,
                  static_cast<uint32_T>(-A_tmp + 6) * sizeof(real_T));
    }
  }
  ...
  for (int32_T i{4}; i >= 0; i--) {
    ...
    if (i + 1 < 5) {
      ...
      if (tau[i] != 0.0) {
        ...
        f_st.site = &yb_emlrtRSI;
        kend = internal::reflapack::ilazlc(f_st, lastv, 4 - i, Q, iy + 6);
      } else {
        lastv = 0;
        kend = 0;
      }
      if (lastv > 0) {
        f_st.site = &ac_emlrtRSI;
        internal::blas::xgemv(f_st, lastv, kend, Q, iy + 6, Q, iy + 1, work);
        f_st.site = &bc_emlrtRSI;
        internal::blas::xgerc(f_st, lastv, kend, -tau[i], iy + 1, work, Q,
                              iy + 6);
      }
      e_st.site = &nc_emlrtRSI;
      internal::blas::xscal(e_st, 4 - i, -tau[i], Q, iy + 2);
    }
    Q[iy] = 1.0 - tau[i];
