                        ...
                        int32_T in7, int32_T in8)
{
  ...
  int32_T stride_1_1;
  int32_T vectorUB;
  in3 = in3_data[static_cast<int32_T>(in4) - 1];
  loop_ub = in2_size;
  ...
  for (i = 0; i < b_loop_ub; i++) {
    b_in5_data[i] = in5_data[i * stride_0_1] -
                    in6_data[(static_cast<int32_T>(in4) +
                              in6_size[0] * (in7 + i * stride_1_1)) -
                             1];
    scalarLB = (loop_ub / 2) << 1;
    vectorUB = scalarLB - 2;
...
void dynamic_size_checks(const emlrtStack &sp, int32_T a_size,
